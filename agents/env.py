...
class Env:
    ...
    def interact(self):
        for _ in range(self.max_turns):
            ...
            if 'You are motivated because' in client_response or 'You should highlight current state and engagement, express a desire to end the current session' in client_response:
                break
